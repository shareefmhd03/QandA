...
+(function (a) {
  ...
  function c(c) {
    return this.each(function () {
      var d = a(this),
        ...
        f = d.data();
      void 0 !== d.data("animations") &&
        null !== d.data("animations") &&
        (f.animations = a.isArray(f.animations)
          ? f.animations
          : f.animations.split(" "));
  ...
  (b.TRANSITION_DURATION = 300),
    ...
    (b.prototype.position = function (b) {
      var c = a(window);
      b.css({ bottom: "", left: "", top: "", right: "" }).removeClass(
        "dropdownhover-top"
      );
      ...
      if (h)
        f.left < 0
          ? ((g = "left"),
            b.removeClass("dropdownhover-right").addClass("dropdownhover-left"))
          : ((g = "right"),
            b
          ...
          e.bottom > d.bottom
            ? b.css({ bottom: "auto", top: -(e.bottom - d.bottom) })
            : e.top < d.top && b.css({ bottom: -(d.top - e.top), top: "auto" });
      else {
        ...
        (j.right = j.left + i.outerWidth()),
          ...
          e.right > d.right &&
            b.css({ left: -(e.right - d.right), right: "auto" }),
          (e.bottom > d.bottom && j.top - d.top > d.bottom - j.bottom) ||
          b.position().top < 0
            ? ((g = "top"),
              b
            ...
            : ((g = "bottom"), b.addClass("dropdownhover-bottom"));
      }
      return g;
    });
  var d = a.fn.dropdownhover;
  (a.fn.dropdownhover = c),
    (a.fn.dropdownhover.Constructor = b),
    (a.fn.dropdownhover.noConflict = function () {
      ...
      clearTimeout(e),
        (e = setTimeout(function () {
          a(window).width() >= 768
            ...
            : a('[data-hover="dropdown"]').each(function () {
                a(this).removeData("bs.dropdownhover"),
                  a(this).hasClass("dropdown-toggle")
                    ? a(this)
                        .parent(".dropdown")
                        .find(".dropdown")
                        .andSelf()
